...
loadd(c(mer_df, binary_ngrams))
load("./results/AmpGram_model.rda")
```
...
<img src="figures/ngrams.png" width="250">
...
as.matrix(binary_ngrams)[1:5, 1:5]
ncol(as.matrix(binary_ngrams))
```
